...
namespace Game1
{
    class Particula
    {
        ...
        public void CreateParticle(GameTime gametime, Vector3 posicaoCentro, float larguraRetangulo, float alturaRetangulo, Vector3 novaDirecao, Tank tank, Matrix worldSistema)
        {
