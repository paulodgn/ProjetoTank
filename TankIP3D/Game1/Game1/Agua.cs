...
namespace Game1
{
    class Agua
    {
        ...
        public Agua(GraphicsDevice device,Texture2D imagemMapaAlturas,Texture2D texturaPlano,float tamanhoPlano,Texture2D textura)
        {
            ...
            for (int x = 0; x < texturaMapa.Height; x++)
            {
                for (int z = 0; z < texturaMapa.Width; z++)
                {
                    ...
                    if (x % 2 == 0)
                    {
                        ...
                        {
                            vertices[x * texturaMapa.Width + z] = new VertexPositionColorTexture(new Vector3(x - posicaoX, alturaAgua/*alturas[x, z] * escala*/, z - posicaoX), Color.White, new Vector2(0, coordenadaTexturaY));// texturaX=0,texturaY=0
                        ...
                        else
                        {
                            ...
                            vertices[x * texturaMapa.Width + z] = new VertexPositionColorTexture(new Vector3(x - posicaoX, alturaAgua, z - posicaoX), Color.White, new Vector2(0, coordenadaTexturaY));// texturaX=0,texturaY=1
                    ...
                    else
                    {
                        if (coordenadaTexturaY == 0)
                        {
                            ...
                            vertices[x * texturaMapa.Width + z] = new VertexPositionColorTexture(new Vector3(x - posicaoX, alturaAgua, z - posicaoX), Color.White, new Vector2(1, coordenadaTexturaY));
                            coordenadaTexturaY = 1;
                        }
                        else
                        {
